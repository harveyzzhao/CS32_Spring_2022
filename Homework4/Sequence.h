...
Sequence<ItemType>::Sequence(const Sequence<ItemType>& other)
{
    ...
    for (Sequence<ItemType>::Node* p = other.m_head->m_next; p != other.m_head; p = p->m_next)
...
int Sequence<ItemType>::insert(int pos, const ItemType& value)
{
    ...
    Sequence<ItemType>::Node* p = nodeAtPos(pos);
...
int Sequence<ItemType>::insert(const ItemType& value)
{
    ...
    for (p = m_head->m_next, pos = 0; p != m_head  &&
                                value >C p->m_value; p = p->m_next, pos++)
        ;
...
int Sequence<ItemType>::remove(const ItemType& value)
{
    ...
    Sequence<ItemType>::Node* p = m_head->m_next;
    while (p != m_head)
    {
        if (p->m_value == value)
        {
...
void Sequence<ItemType>::swap(Sequence<ItemType>& other)
{
    ...
    Sequence<ItemType>::Node* p = other.m_head;
    other.m_head = m_head;
    m_head = p;
...
void Sequence<ItemType>::createEmpty()
{
    ...
    m_head = new Sequence<ItemType>::Node;
...
void Sequence<ItemType>::insertBefore(Sequence<ItemType>::Node* p, const ItemType& value)
{
    ...
    Sequence<ItemType>::Node* newp = new Sequence<ItemType>::Node;
    newp->m_value = value;
